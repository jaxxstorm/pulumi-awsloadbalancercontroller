...
namespace Pulumi.Awsloadbalancercontroller
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Awsloadbalancercontroller.version.txt");
    ...
    internal sealed class AwsloadbalancercontrollerResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AwsloadbalancercontrollerResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
