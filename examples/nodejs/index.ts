...
const loadbalancer = new lb.Deployment("example", {
    ...
    oidcProvider: "arn:aws:iam::616138583583:oidc-provider/oidc.eks.us-west-2.amazonaws.com/id/6F5EB6A0B6482BE2960BD584BA77B7FB",
    oidcIssuer: "oidc.eks.us-west-2.amazonaws.com/id/6F5EB6A0B6482BE2960BD584BA77B7FB",
    namespace: "aws-loadbalancer-controller",
    installCRDs: true,
    //clusterName: "example-cluster",
    clusterName: "nginx-helm-helm-eksCluster-4bae6a4"
})
